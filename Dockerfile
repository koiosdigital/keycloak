...
ADD --chown=keycloak:keycloak --chmod=644 https://github.com/klausbetz/apple-identity-provider-keycloak/releases/download/1.16.0/apple-identity-provider-1.17.0.jar /opt/keycloak/providers/apple-identity-provider-1.7.0.jar
